        ...
        items: [
          // USER
          {
            ...
            children: [
              ...
              // { title: t('View Task'), path: paths.dashboard.user.list }
              // { title: t('Create Task'), path: paths.dashboard.user.create_task },
              { title: t('Create Task'), path: paths.dashboard.user.create},
              { title: t('View Task'), path: paths.dashboard.user.list},
...

           {
            ...
            icon: ICONS.chat,
            children: [
              { title: t('Create Project'), path: paths.dashboard.project.create },
              { title: t('View Project'), path: paths.dashboard.project.view },
            ],
          },
          ...
          //   path: paths.dashboard.create_project,
          //   icon: ICONS.folder,
          // },
          // {
          //   title: t('View Project'),
          //   path: paths.dashboard.view_project,
          //   icon: ICONS.folder,
          // },
          {
            title: t('calendar'),
          ...
          //   icon: ICONS.chat,
          //   children: [
          //     { title: t('Create Task'), path: paths.dashboard.task.create },
          //     { title: t('View Task'), path: paths.dashboard.task.view },
          //   ],
          // },
        // {
        //   title: t('create_task'),
        //   path: paths.dashboard.create_task,
        //   icon:  ICONS.folder,
        // },
          // // KANBAN
          // {
